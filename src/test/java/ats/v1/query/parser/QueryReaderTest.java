...
class QueryReaderTest {
    ...
    void shouldParseSimpleQueryCorrectly() {
        ...
        assertThat(tokens.get(0).getType()).isEqualTo(QueryToken.SELECT);
        assertThat(tokens.get(1).getType()).isEqualTo(QueryToken.LEXEME);
        assertThat(tokens.get(1).getLexeme()).isEqualTo("s1");
        assertThat(tokens.get(2).getType()).isEqualTo(QueryToken.SUCH);
        assertThat(tokens.get(3).getType()).isEqualTo(QueryToken.THAT);
        assertThat(tokens.get(4).getType()).isEqualTo(QueryToken.FOLLOWS);
        assertThat(tokens.get(5).getType()).isEqualTo(QueryToken.LEFT_PAREN);
        assertThat(tokens.get(6).getType()).isEqualTo(QueryToken.LEXEME);
        assertThat(tokens.get(6).getLexeme()).isEqualTo("s1");
        assertThat(tokens.get(7).getType()).isEqualTo(QueryToken.AND);
        assertThat(tokens.get(8).getType()).isEqualTo(QueryToken.LEXEME);
        assertThat(tokens.get(8).getLexeme()).isEqualTo("s2");
        assertThat(tokens.get(9).getType()).isEqualTo(QueryToken.RIGHT_PAREN);
    }
    ...
    void shouldParseQueryCorrectly() {
        ...
        assertThat(tokens.get(2).getType()).isEqualTo(QueryToken.SUCH);
        assertThat(tokens.get(3).getType()).isEqualTo(QueryToken.THAT);
        assertThat(tokens.get(4).getType()).isEqualTo(QueryToken.FOLLOWS_PLUS);
        assertThat(tokens.get(5).getType()).isEqualTo(QueryToken.LEFT_PAREN);
        assertThat(tokens.get(6).getType()).isEqualTo(QueryToken.NUMBER);
